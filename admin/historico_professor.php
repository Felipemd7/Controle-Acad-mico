...
?>
   <table width="900" border="0">
    ...
    <tr>
      <td><h2><strong>Disciplinas que este professor ensina:</strong> <?php $sql_2 = mysqli_query($db,"SELECT * FROM disciplinas WHERE professor = '$code'"); echo mysqli_num_rows($sql_2); ?></h2></td>
    </tr>
