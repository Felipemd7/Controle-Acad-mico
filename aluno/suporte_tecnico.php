...
mysqli_query($db,"INSERT INTO mural_coordenacao (date, status, curso, titulo) VALUES ('$date', 'Ativo', 'Não informado', 'Existe uma nova mensagem enviada pelo aluno para ser respondida')");
}
	...
	?>
     <table border="0">
      ...
      <tr>
        ...
        <?php
        if($res_5['resposta'] == ''){
			 echo "<h4 class='h4'>Aida não existe resposta para este chamado!</h4>";
		}else{
