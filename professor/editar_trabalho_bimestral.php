...
$sql_6 = mysqli_query($db,"INSERT INTO mural_aluno (date, status, curso, titulo) VALUES ('$date', 'Ativo', '$curso', 'Foi alterado o trabalho bimestral de $dis com encerramento no dia $encerramento - Para ver mais detalhes vá em AVALIAÇÕES')");
