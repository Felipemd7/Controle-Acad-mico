...
<ul>
 ...
 <li>Não se esqueça que antes de você reajustar a mensalidade, você deve ter outorização da coordenação para executar tal função.</li>
 <li>Atenção, se você enviar um alerta de cobrança ao aluno você será a responsável por tal atitudade.</li>
...
$sql_2 = mysqli_query($db,"INSERT INTO fluxo_de_caixa (status, tipo, d, m, a, date_completo, date, codigo, descricao, valor, form_pag) VALUES ('Ativo', 'CRÉDITO', '$d', '$m', '$a', '$date', '$dia', 'mensalidade=$code', 'Mensalidade do aluno: $matricula Competencia: $m/$a', '$valor', '$forma_de_pagamento')");
...
$sql_2 = mysqli_query($db,"INSERT INTO mural_coordenacao (date, status, curso, titulo) VALUES ('$date', 'Ativo', 'Não informado', 'A mensalidade de um aluno foi reajustada!')");
